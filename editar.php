            ...
            <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="titulo" name="titulo"
                                    aria-describedby="emailHelp" placeholder="Futbol" value="<?php echo $titulo ?>" />
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="fecha" name="fecha"
                                    value="<?php echo $fecha ?>" aria-describedby="emailHelp" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="input-group mb-3">
                        <input type="time" name="hDesde" class="form-control" placeholder="Username"
                            aria-label="Username" id="hDesde" value="<?php echo $hora_inicio ?>" />
                        <span class="input-group-text">-</span>
                        <input type="time" name="hHasta" class="form-control" placeholder="Server" aria-label="Server"
                            id="hHasta" value="<?php echo $hora_final ?>" />
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <input class="form-control" type="text" id="actividades" name="actividades"
                        placeholder="ingrese una actividad" list="actividades_list" value="<?php echo $actividad ?>" />
                    <?php
                    require_once("class/agenda.php");
                    $obj_actividad = new agenda();
